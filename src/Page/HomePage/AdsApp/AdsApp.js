...
const AdsApp = () => {
    ...
    return (
        <div className="adsApp py-10 mt-20">
            <div className="flex">
                <div className="content w-1/2 text-zinc-200 pl-60">
                    <h2 className=" text-3xl font-bold mt-20 leading-[70px]">
                    ...
                    <button
                        type="button"
                        className="text-md text-zinc-100 bg-orange-700 border border-orange-700 duration-200 hover:border-orange-700 hover:bg-black hover:text-orange-700  font-bold rounded-lg px-10 py-3 mr-2 mb-2 min-w-[140px]"
                    >
                        DOWNLOAD
                    </button>
                </div>
                <div className="img_block w-1/2 relative ml-32">
